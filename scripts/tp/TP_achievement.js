...
*/
    ...
    if(!Vars.headless) MDL_event.onLoad(() => {
        ...
        new CLS_achievement(
            "projreind", "wet-foot",
            new TextureRegionDrawable(Core.atlas.find("projreind-icon-big-wet-foot")),
        ...
        function checkItem(b, item, itemName) {
            return !Vars.net.client() && Vars.state.isCampaign() && b.team === Vars.state.rules.defaultTeam && item.name === itemName;
        };
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-copper")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-tin-bronze")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-steel")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0misc-generic-tech-point-t1")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-mangalloy")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-coke")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-rubber")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-asbestos-wool")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-cement")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-stainless-steel")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-cupronickel")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0chem-sodium-chloride")) this.complete();
            },
        );
        ...
        new CLS_achievement(
            ...
            TRIGGER.itemProduce,
            function(b, item, amt) {
                if(checkItem(b, item, "loveclab-item0misc-black-powder")) this.complete();
            },
        );
