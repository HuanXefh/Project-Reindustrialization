...
*/
    ...
    require("projreind/ct/CT_BLK_fluidPackager");
    ...
    require("projreind/tp/TP_achievement");
    require("projreind/tp/TP_dialFlow");
            ...
            const winWelcome = new CLS_window(MDL_bundle.getInfo("projreind", "dial-welcome"), cont => {
                ...
                cont.table(Styles.none, tb => {
                    tb.pane(pnTb => {
                        ...
                        MDL_table.br(pnTb, 3);
                        MDL_table.wrapLine(pnTb, MDL_bundle.getInfo("projreind", "dial-welcome", true), {padOrd: 1});
                    });
                    MDL_table.br(tb);
                ...
                // `TABLE`: splitter
                cont.table(Styles.none, tb => {
                    MDL_table.barV(tb, {color: Pal.accent, stroke: 8.0});
